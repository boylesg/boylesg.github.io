		...
		<div class="masthead" id="masthead">
			...
			<nav class="navigation" id="navigation">
				<ul class="navigation_list">
					...
					<li class="navigation_list_item" style="display:<?php if (isset($_SESSION["account_admin"]) && $_SESSION["account_admin"]) echo "block"; else echo "none";?>;">
					<a class="navigation_link" href="../admin.php">ADMIN</a></li>
				</ul>
