...
CREATE TABLE `members` (
  ...
  `structure` varchar(32) DEFAULT NULL,
  `license` varchar(128) DEFAULT NULL,
  `description` varchar(1024) DEFAULT NULL,
  `minimum_charge` int(10) UNSIGNED DEFAULT NULL,
  `minimum_budget` int(10) UNSIGNED DEFAULT NULL,
  `maximum_size` varchar(16) DEFAULT NULL,
  `maximum_distance` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `members` (`id`, `trade_id`, `business_name`, `first_name`, `surname`, `profile_filename`, `abn`, `structure`, `license`, `description`, `minimum_charge`,
						`minimum_budget`, `maximum_size`, `maximum_distance`, `logo_filename`, `unit`, `street`, `suburb`, `state`, `postcode`, `phone`, `mobile`, 
                        `email`, `username`, `password`, `expiry_date`, `date_joined`) 
						VALUES (1, 52, 'Greg\'s Native Landscapes', 'Greg', 'Boyles', 'Gregary_Boyles_profile.jpg', '51 824 753 556', 'Sole trader', 'Electrical license\r\nClass A\r\nNumber: 8743895324', 'Ecological weed control\r\nLow maintenance\r\nDrought tolerant\r\nIrrigation systems\r\nSmall retaining walls\r\nSmall tree removal\r\nGeneral pruning\r\nBush tucker gardens\r\nSmall ornamental billabongs\r\nNative lawns', 0000000120, 0000005000, 'Up to 50', 0000000100, 'Logo.jpg', 'Unit 3, building 6(Cooper)', '56 Derby Drive', 'EPPING', 'VIC', '3076', '94013696', '0455328886', 'gregplants@bigpond.com', 'gregaryb', 'password', '2024-11-08', '2023-11-07 11:25:49'),
								...
								(22, 59, NULL, 'Hermione', 'Granger', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '86 Shaw Drive', 'Maryborough', 'VIC', '3465', '53666640', '0419349268', 'hermione.granger@gmail.com', 'grangerh', 'password', NULL, '2023-11-20 07:15:35'),
...
CREATE TABLE `advert_spaces` (
  `id` int UNSIGNED NOT NULL,
  `space_code` varchar(24) NOT NULL,
  `space_description` varchar(64) NOT NULL,
...
CREATE TABLE `jobs` (
  ...
  `urgent` tinyint(1) NOT NULL DEFAULT NULL,
  `completed` tinyint(1) NOT NULL DEFAULT NULL
);
