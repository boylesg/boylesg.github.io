...
<!-- #BeginTemplate "../events_master.dwt" -->
	...
	<head>
		...
		<title>Events - Parent Pathways</title>
		<!-- #EndEditable -->
		...
		<div id="container">
			...
			<div class="below_masthead">
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li class="submenu_item">
								<a href="parent_pathways.php"><b>Parent Pathways</b></a></li>
								<li class="submenu_item">
				...
				<div class="content">
					...
					<?php 
						$g_strGroupName = "parent_pathways";
						...
						<table cellpadding="0" cellspacing="5" border="0" id="login_form">
							...
							<tr>
								<td colspan="2" style="text-align:right;">
									<input type="hidden" value="<?php echo $g_strGroupName; ?>" name="username" />
