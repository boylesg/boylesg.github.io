...
<!-- #BeginTemplate "../events_master.dwt" -->
	...
	<head>
		...
		<title>Events - Millhouse Playgroup</title>
		<!-- #EndEditable -->
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li class="submenu_item">
								<a href="playgroup.php"><b>Millhouse Playgroup</b></a></li>
								<li class="submenu_item">
					...
					<form class="form" target="_self" method="post" id="login_form" style="display:<?php echo $_SESSION["display_login_form"]; ?>">
						<table cellpadding="0" cellspacing="5" border="0">
							...
							<tr>
								...
								<td><input name="password" id="password" type="passord"/></td>
							</tr>
							<tr>
